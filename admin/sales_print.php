<?php
	...
	function generateRow($from, $to, $conn){
		...
		foreach($stmt as $row){
			...
			<tr>
				...
				<td>'.$row['pay_id'].'</td>
				<td align="right">'.number_format($amount, 2).' AKZ</td>
			</tr>
			';
		}
	...
	if(isset($_POST['print'])){
	    ...
	    $content .= '
	      	...
	      	<h4 align="center">INFORMAÇÕES DE VENDA</h4>
	      	<h4 align="center">'.$from_title." - ".$to_title.'</h4>
	      	<table border="1" cellspacing="0" cellpadding="3">  
	           <tr>  
	           		<th width="15%" align="center"><b>Data</b></th>
	                <th width="30%" align="center"><b>Nome do Cliente</b></th>
					<th width="40%" align="center"><b>Transação#</b></th>
					<th width="15%" align="center"><b>Quantia</b></th>  
	           </tr>  
	      ';  
