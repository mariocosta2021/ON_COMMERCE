                    ...
                    try{
                      ...
                      foreach($stmt as $row){
                        ...
                        echo "
                          <tr>
                            <td class='hidden'></td>
                            <td>".date('d / m / Y - H:i', strtotime($row['sales_date']))."</td>
                            <td>".$row['firstname'].' '.$row['lastname']."</td>
                            <td>".$row['pay_id']."</td>
                            <td>".number_format($total, 2)." AKZ</td>
                            <td><button type='button' class='btn btn-info btn-sm btn-flat transact' data-id='".$row['salesid']."'><i class='fa fa-eye'></i> Ver</button></td>
