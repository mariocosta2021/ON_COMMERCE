		...
		if($row['numrows'] > 0){
			...
			try{
				...
				$message = "
					...
					<p>Seus dados:</p>
					<p>Email: ".$email."</p>
					<p>Click no link abaixo para restauração a sua senha.</p>
					<a href='http://localhost/ecommerce/password_reset.php?code=".$code."&user=".$row['id']."'>Recuperar senha</a>
				";
