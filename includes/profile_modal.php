    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b> Todos detalhes da transação</b></h4>
            </div>
            ...
            <div class="modal-footer">
              ...
              id="invoicePdf"
              target="_blank"
              class="btn btn-primary btn-flat pull-left" ><i class="fa fa-print"></i> Imprimir</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Actualizar conta</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="profile_edit.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="contact" class="col-sm-3 control-label">Informações de Contacto</label>
                ...
                <div class="form-group">
                    <label for="photo" class="col-sm-3 control-label">Imagem</label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="password" class="form-control" id="curr_password" name="curr_password" placeholder="Digite a sua senha para salvar as alterações" required>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
