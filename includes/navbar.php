  ...
  <nav class="navbar navbar-static-top">
    <div class="container">
      <div class="navbar-header">
        <a href="index.php">
        <img src="images/itel.png" class="img-fluid" alt="" style="width: 25%; color: #fff;"> <brand style="color: #fff;">PAP 2022/2023</brand> 
        </a>
      ...
      <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              <li><a href="index.php">Todas Categorias</a></li>
              <hr>
              <?php
        ...
        <form method="POST" class="navbar-form navbar-left" action="search.php">
          <div class="input-group">
              <input type="text" class="form-control" id="navbar-search-input" name="keyword" placeholder="Pesquisar produto" required>
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="cart_view.php">Ir ao carrinho</a></li>
            </ul>
          </li>
          <?php
