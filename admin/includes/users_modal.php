            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="number" class="form-control" id="contact" name="contact" min ="9" max-length ="9" mim-length ="9">
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="users_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_lastname" class="col-sm-3 control-label">Apelido</label>
                ...
                <div class="form-group">
                    <label for="edit_contact" class="col-sm-3 control-label">Informações de Contacto </label>
